...
Latest report: [WG-FSA-2023/05](https://meetings.ccamlr.org/en/wg-fsa-2023/05)
...
Every year new catch limits are agreed upon. Record the previous catch limits in the file *CLs.csv* by adding a column every year. If a new RB is created, add a row for it. Use the *GetCLs* script (only once a year), but always double check with the SC table of catch limits.
