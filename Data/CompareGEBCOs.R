...
tmpdir="E:/Rtemp"
#Get Bathy
Bold=rast("I:/Science/Projects/GEBCO/2025/Processed/GEBCO2025_LL.tif")
Bnew=rast("I:/Science/Projects/GEBCO/2026/Processed/GEBCO2026_LL.tif")
...
png(filename = 'Data/Map_GEBCOComparison_2026.png', width = 2000, height = 1900, units = "px", pointsize = 12,
    bg = "white", res = 200)
