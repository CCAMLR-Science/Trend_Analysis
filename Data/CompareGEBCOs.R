...
tmpdir="E:/Rtemp"
#Get Bathy
Bold=rast("I:/Science/Projects/GEBCO/2024/Processed/GEBCO2024_LL.tif")
Bnew=rast("I:/Science/Projects/GEBCO/2025/Processed/GEBCO2025_LL.tif")
...
png(filename = 'Data/Map_GEBCOComparison_2025.png', width = 2000, height = 1900, units = "px", pointsize = 12,
    bg = "white", res = 200)
