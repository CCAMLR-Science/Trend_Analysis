...
tmpdir="E:/Rtemp"
#Get Bathy
B20=rast("I:/Science/Projects/GEBCO/2020/Processed/GEBCO2020_LL.tif")
B21=rast("I:/Science/Projects/GEBCO/2021/Processed/GEBCO2021_LL.tif")
Bdiff=B21-B20 #Negative means deeper

#Project extent (a single point is enough)
ExtP=CCAMLRGIS::project_data(Input=data.frame(Lat=c(-40),Lon=c(0)),NamesIn = c("Lat","Lon"))$Y
...
png(filename = 'Data/Map_GEBCOComparison.png', width = 2000, height = 1900, units = "px", pointsize = 12,
    bg = "white", res = 200)
...
min(Dc)
Dp=add_col(var=c(-1500,-100),cuts=10,cols=c("red","#FFDFDF"))
Ds=add_col(var=c(100,2050),cuts=10,cols=c("#DFDFFF","blue"))

Dcuts=c(Dp$cuts,Ds$cuts)
Dcols=c(Dp$cols,"white",Ds$cols)

png(filename = 'Data/Map_GEBCOComparison_883.png', width = 2000, height = 2000, units = "px", pointsize = 12,
    bg = "white", res = 200)
# par(mai=c(0,0,0,3),xaxs='i',yaxs='i')
